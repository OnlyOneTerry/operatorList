    ...
    ui(new Ui::GuidBasicSetting)
{
    ...
    ui->doubleSpinBox_reduceRatio->setValue(40);
...
void GuidBasicSetting::enableNextStep()
{
    ...
    else if(ui->doubleSpinBox_reduceRatio->value() == 0)
    {
        emit sig_enableNextStep(false);
        return;
    }
...
void GuidBasicSetting::on_doubleSpinBox_reduceRatio_valueChanged(double arg1)
{
