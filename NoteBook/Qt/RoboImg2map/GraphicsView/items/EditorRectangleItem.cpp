...
//void EditorRectangleItem::paint(QPainter * painter,
...
{
    return QRectF(m_line[BEGIN],m_line[END]).normalized();;///*mapFromScene(*/ m_item->sceneBoundingRect()/* ).boundingRect()*/;
}
...
{
    qDebug()<<"EditorRectangleItem::fromXml";
    m_line.clear();
    m_initialized = true;
    bool ok = true;
